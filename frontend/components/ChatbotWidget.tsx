...
export default function ChatbotWidget({
  ...
  return (
    <div className="fixed bottom-5 right-3 sm:right-5 z-[55] flex flex-col items-end gap-3">
      ...
      <button
        onClick={() => setOpen(o => !o)}
        className="w-12 h-12 rounded-full bg-[#CC0000] shadow-lg shadow-red-900/40 flex items-center justify-center hover:bg-[#aa0000] hover:scale-105 active:scale-95 transition-all"
