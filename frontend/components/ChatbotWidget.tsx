      ...
      {open && (
        ...
        >
          ...
          <div className="flex flex-shrink-0" style={{ borderBottom: `1px solid ${headerBorder}` }}>
            ...
            >
              <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden bg-[#0EA5E9]">
                <img src="/chatbot-icon.jpg" alt="" className="w-full h-full object-cover" />
              </div>
              <div>
            ...
            <div
              ...
              style={{ backgroundColor: headerBg }}
            >
              <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden ${mobileTab === 'faq' ? 'bg-[#0EA5E9]' : 'bg-[#4F6BED]'}`}>
                {mobileTab === 'faq' ? (
                  <img src="/chatbot-icon.jpg" alt="" className="w-full h-full object-cover" />
                ) : (
                  <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
