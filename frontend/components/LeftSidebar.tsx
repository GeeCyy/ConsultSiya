  ...
  const SidebarContent = () => (
    <div className={`flex flex-col h-full ${sbBg}`}>
      ...
      <div className={`border-t ${sbBdr} px-2 py-3 space-y-0.5 flex-shrink-0`}>
        ...
        >
          <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M5.636 5.636a9 9 0 1 0 12.728 0M12 3v9" /></svg>
          Sign Out
        </button>
      </div>
