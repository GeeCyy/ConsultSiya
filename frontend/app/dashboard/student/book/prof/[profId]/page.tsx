    ...
    <div className={`min-h-screen ${bgClass}`} style={bgStyle}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 relative z-10">
        ...
        <div className="mb-6">
          ...
          <p className={`text-sm mt-1 ${ts}`}>{rescheduleId ? 'Choose a new date and time for your rescheduled consultation.' : 'Fill in the details below to request a consultation session. Your advising slip will be downloaded automatically upon confirmation.'}</p>
        </div>
