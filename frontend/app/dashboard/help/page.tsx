...
function FaqItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border border-white/10 rounded-xl overflow-hidden" style={{ backgroundColor: '#2b2d31' }}>
      <button
        onClick={() => setOpen(v => !v)}
      ...
      {open && (
        <div className="px-5 pb-4 text-sm text-gray-400 leading-relaxed border-t border-white/5" style={{ backgroundColor: '#383a40' }}>
    ...
    <DashboardShell>
      <div className="min-h-screen" style={{ backgroundColor: '#1e1f22' }}>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10" style={{ backgroundColor: '#2b2d31' }}>
          ...
          <p className="text-xs text-gray-500">ConsultSiya Documentation</p>
        </div>
          ...
          <div className="flex gap-8">
            ...
            <aside className="w-56 flex-shrink-0 hidden md:block">
              <div className="sticky top-8 space-y-1">
                <p className="text-[10px] font-semibold text-gray-600 uppercase tracking-wider px-3 mb-3">Sections</p>
                {SECTIONS.map(s => (
                  <button
                    key={s.id}
                    onClick={() => {
            ...
            <main className="flex-1 space-y-12 min-w-0">
              ...
              <section id="about">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-lg font-bold text-white">About the System</h2>
                    <p className="text-xs text-gray-500">ConsultSiya — SOIT Academic Consultation System</p>
                  </div>
                </div>
                <div className="rounded-2xl p-6 border border-white/10 space-y-4" style={{ backgroundColor: '#2b2d31' }}>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    <span className="font-semibold text-white">ConsultSiya</span> is the official academic consultation management system of the School of Industrial Engineering and Information Technology (SOIT) at Mapúa University. It streamlines the process of scheduling, managing, and documenting student-professor consultations.
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                    {[
                      ...
                      <div key={label} className="rounded-xl p-4 border border-white/5" style={{ backgroundColor: '#383a40' }}>
              ...
              <section id="howto">
                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-2xl p-6 border border-white/10" style={{ backgroundColor: '#2b2d31' }}>
                    <p className="text-sm font-bold text-white mb-4">For Students</p>
                  ...
                  {/* Professors */}
                  <div className="rounded-2xl p-6 border border-white/10" style={{ backgroundColor: '#2b2d31' }}>
                    <p className="text-sm font-bold text-white mb-4">For Professors</p>
                    <ol className="space-y-3">
                      {[
              ...
              <section id="guidelines">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-lg font-bold text-white">Submission Guidelines</h2>
                </div>
                <div className="rounded-2xl p-6 border border-white/10 space-y-4" style={{ backgroundColor: '#2b2d31' }}>
                  {[
              ...
              <section id="contact">
                ...
                <div className="rounded-2xl p-6 border border-white/10 grid grid-cols-1 sm:grid-cols-2 gap-6" style={{ backgroundColor: '#2b2d31' }}>
                  {[
                    ...
                    <div key={label} className="flex gap-4 p-4 rounded-xl border border-white/5" style={{ backgroundColor: '#383a40' }}>
                      <span className="text-2xl flex-shrink-0">{icon}</span>
                      <div>
                        <p className="text-sm font-semibold text-white">{label}</p>
                        <p className="text-xs text-gray-400 leading-relaxed mt-1">{value}</p>
                      </div>
                    </div>
                  ))}
                </div>
                <div className="mt-4 rounded-xl px-5 py-4 border border-white/5 flex items-center gap-3" style={{ backgroundColor: '#2b2d31' }}>
                  <svg className="w-4 h-4 text-[#CC0000] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <p className="text-xs text-gray-400">
                    You can also use the <span className="text-white font-semibold">ConsultSiya Assistant</span> chatbot (bottom-right corner) to get quick answers about professors and how to book.
                  </p>
                </div>
              </section>
            </main>
